...
load("~/AIMS@JCU/CoralSeaSymbioants/ITS2_acropora_CS_2024/kdist_acro_symbioant.RData")
```
...
# Start plotting the composition data
plot_df_acro_symbioant <- all_data %>%
